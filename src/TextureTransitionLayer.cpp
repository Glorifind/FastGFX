...
namespace fgfx {
  ...
  TextureTransitionLayer::TextureTransitionLayer(Engine* enginep) : Layer(enginep) {
    composition=1;
  };
  ...
  void TextureTransitionLayer::beginDraw(glm::mat4 cameraMatrix) {
    ...
    glUniformMatrix4fv(TextureTransitionLayer::textureTransitionProgramUniformCameraMatrix, 1, GL_FALSE, (GLfloat*)glm::value_ptr(cameraMatrix));
  }
  ...
  void TextureTransitionLayer::render(glm::mat4 cameraMatrix) {
    if(!visible) return;
